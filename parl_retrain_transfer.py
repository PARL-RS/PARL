...
def parse_args():
    """Arguments"""
    parser = argparse.ArgumentParser(description="Retrain the data based on the poison results (transfer setting).")
...
if __name__ == '__main__':
    ...
    value_net1 = DuelDQN_Net2(dim,num_items).to(device)
    target_value_net1 = DuelDQN_Net2(dim,num_items).to(device)
    ...
    params1_m = (dataset_name,attack_type,fill_num,item_id,poi_rat,constrain_th,exp_ind,order_rearrangement_flag,retrain_idx)
    ...
    if save_type == 0:
        ...
        save_name = weight_dir + '%s_dqn_transfer_weight_%s_%s_%s_%s_%s_%s_%s_%s_%s_%s_%s_%s_%s_%s_%s_%s_%s_%s_%s_%s_%s_%s_%s_%s.pkl' %(params_m)
        
    elif save_type == 1:
        params_m = params1_m
        save_name = weight_dir + '%s_dqn_transfer_weight_%s_%s_%s_%s_%s_%s_%s_%s.pkl' %(params_m)
    ...
    csv_name1 = res_dir + 'dqn_retrain_transfer_%s_%s_1.csv' %(dataset_name,attack_type)
